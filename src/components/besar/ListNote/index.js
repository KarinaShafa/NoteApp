...
import { deleteNote } from "../../../actions/AuthAction"; //memanggil fungsi, variabel, atau objek yang telah didefinisikan di file atau modul lain
...
const ListNote = ({ judul, isi, tanggal, status, category, noteId }) => {
  ...
  const handleDeleteClick = () => {
    deleteNote(noteId); //menghapus catatan dengan ID yang sesuai dari penyimpanan data yang mungkin diatur di dalam fungsi deleteNote yang  diimpor 
